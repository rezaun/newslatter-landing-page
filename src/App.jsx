			...
			<main className="container mx-auto px-6 pt-16 flex-1 text-center">
				...
				<form 
					...
					<div className="opacity-75 italic">
						By subscribing, you agree with Revue's <a target="_blank" href="javascript:void(0)" className="hover:opacity-80 duration-150">Terms of Service</a> and <a target="_blank" href="" className="hover:opacity-80 duration-150">Privacy Policy</a>.
					</div>
